...
<head>
    ...
    <title>Danh sách đơn hàng của {{ $user->us_name }}</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container mt-4">
            ...
            <div class="container-a">
                <h2 class="text-center mb-4">Danh sách đơn hàng của: {{ $user->us_name }}</h2>
    ...
    <!-- JavaScript để thêm màu nền xen kẽ và hover cho các nhóm đơn hàng -->
    <script>
