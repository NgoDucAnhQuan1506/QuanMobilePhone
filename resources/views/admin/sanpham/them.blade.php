...
<body>
    ...
    <div class="main-content">
        ...
        <h2 class="text-center mb-4 bg-success text-white p-3 rounded">Thêm Sản Phẩm</h2>

            <!-- Form thêm sản phẩm -->
            <form method="POST" enctype="multipart/form-data" action="{{ route('themSanpham') }}">
                @csrf
                ...
                <!-- Trạng thái mở bán -->
                <div class="mb-3">
                    <label for="is_active" class="form-label">Trạng thái mở bán</label>
